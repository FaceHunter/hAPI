...
extern "C"
{
	...
	__declspec(dllexport) void __cdecl SteamAPI_RegisterCallResult(CCallbackBase* result, SteamAPICall_t callID)
	{
	...
	__declspec(dllexport) void __cdecl SteamAPI_RegisterCallback(CCallbackBase *callback, int type)
	{
	...
	__declspec(dllexport) void __cdecl SteamAPI_UnregisterCallResult(CCallbackBase* result, SteamAPICall_t callID)
	{
		Log::Debug("SteamAPI", "%s(CCallbackBase*, %i) = %i", __FUNCTION__, callID);
	...
	__declspec(dllexport) void __cdecl SteamAPI_UnregisterCallback(CCallbackBase *callback, int type)
	{
		Log::Debug("SteamAPI", "%s(CCallbackBase*, %i) = %i", __FUNCTION__, type);
